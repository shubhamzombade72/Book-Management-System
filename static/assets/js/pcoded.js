...
for (var t = 0; t < tc.length; t++) {
  tc[t].setAttribute('src', '/stat/static/assets/images/logo-white.svg');
}
...
function layout_change(layout) {
  ...
  if (layout == 'dark') {
    ...
    if (document.querySelector('[data-pc-layout="horizontal"] .pc-sidebar .m-header .logo-lg')) {
      document.querySelector('[data-pc-layout="horizontal"] .pc-sidebar .m-header .logo-lg').setAttribute('src', '/static/assets/images/logo-white.svg');
    }
    if (document.querySelector('.auth-wrapper a>img')) {
      document.querySelector('.auth-wrapper a>img').setAttribute('src', '/static/assets/images/logo-white.svg');
    }
    ...
    if (document.querySelector('.auth-wrapper a>img')) {
      document.querySelector('.auth-wrapper a>img').setAttribute('src', '/static/assets/images/logo-dark.svg');
    }
    if (document.querySelector('[data-pc-layout="horizontal"] .pc-sidebar .m-header .logo-lg')) {
      document.querySelector('[data-pc-layout="horizontal"] .pc-sidebar .m-header .logo-lg').setAttribute('src', '/static/assets/images/logo-dark.svg');
    }
    var control = document.querySelector('.theme-layout .btn.active');
    if (control) {
      document.querySelector('.theme-layout .btn.active').classList.remove('active');
